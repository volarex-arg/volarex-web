          ...
          <div className="bg-[#2a2a2a] rounded-3xl p-8 md:p-12 border border-white/10">
            ...
            <div className="flex flex-col gap-4 mb-8">
              ...
              <a
                ...
                className="w-full flex items-center justify-center gap-4 bg-[#25D366] hover:bg-[#20bc5a] text-white font-semibold text-xl rounded-2xl px-8 py-5 transition-colors"
              >
              ...
              {/* Botón Instagram */}
              <a
                href="https://www.instagram.com/volarex_arg/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-full flex items-center justify-center gap-4 bg-gradient-to-r from-[#833AB4] via-[#FD1D1D] to-[#F77737] hover:opacity-90 text-white font-semibold text-xl rounded-2xl px-8 py-5 transition-opacity"
              >
                <svg className="w-7 h-7 flex-shrink-0" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
              ...
              {/* Botón LinkedIn */}
              <a
                href="https://www.linkedin.com/company/volarexarg/?viewAsMember=true"
                target="_blank"
                rel="noopener noreferrer"
                className="w-full flex items-center justify-center gap-4 bg-[#0A66C2] hover:bg-[#0958a8] text-white font-semibold text-xl rounded-2xl px-8 py-5 transition-colors"
              >
                <svg className="w-7 h-7 flex-shrink-0" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
